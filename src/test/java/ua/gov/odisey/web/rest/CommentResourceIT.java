...
import ua.gov.odisey.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().text(DEFAULT_TEXT).date(DEFAULT_DATE).author(DEFAULT_AUTHOR);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().text(UPDATED_TEXT).date(UPDATED_DATE).author(UPDATED_AUTHOR);
        return comment;
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.text(UPDATED_TEXT).date(UPDATED_DATE).author(UPDATED_AUTHOR);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).author(UPDATED_AUTHOR);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).date(UPDATED_DATE).author(UPDATED_AUTHOR);
