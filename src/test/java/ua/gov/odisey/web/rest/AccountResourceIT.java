...
import static ua.gov.odisey.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import ua.gov.odisey.config.Constants;
import ua.gov.odisey.domain.PersistentToken;
import ua.gov.odisey.domain.User;
import ua.gov.odisey.repository.AuthorityRepository;
import ua.gov.odisey.repository.PersistentTokenRepository;
import ua.gov.odisey.repository.UserRepository;
import ua.gov.odisey.security.AuthoritiesConstants;
import ua.gov.odisey.service.UserService;
import ua.gov.odisey.service.dto.AdminUserDTO;
import ua.gov.odisey.service.dto.PasswordChangeDTO;
import ua.gov.odisey.service.dto.UserDTO;
import ua.gov.odisey.web.rest.vm.KeyAndPasswordVM;
import ua.gov.odisey.web.rest.vm.ManagedUserVM;
