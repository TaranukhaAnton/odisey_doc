...
class AttachmentResourceIT {
    ...
    void putExistingAttachment() throws Exception {
        ...
        updatedAttachment.description(UPDATED_DESCRIPTION).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
    ...
    void fullUpdateAttachmentWithPatch() throws Exception {
        ...
        partialUpdatedAttachment.description(UPDATED_DESCRIPTION).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
