...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dodument.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DODUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DODUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DODUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DODUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DODUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DODUMENT actions', async () => {
      const expectedActions = [
        {
